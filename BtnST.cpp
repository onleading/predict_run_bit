...
{
	m_crColors[BTNST_COLOR_BK_IN]		= RGB(128,128,128);
	m_crColors[BTNST_COLOR_FG_IN]		= RGB(0,0,0);
	m_crColors[BTNST_COLOR_BK_OUT]		= RGB(128,128,128);
	m_crColors[BTNST_COLOR_FG_OUT]		= RGB(0,0,0);
	m_crColors[BTNST_COLOR_BK_FOCUS]	= RGB(128,128,128);
	m_crColors[BTNST_COLOR_FG_FOCUS]	= RGB(0,0,0);
...
void CButtonST::SetTransparent(BOOL bTransparent)
{
...
void CButtonST::setText(UINT nID)
{
	CString str;
	str.LoadString(nID);
	SetWindowText(str);
