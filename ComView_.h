...
protected:
	...
	void	GetMainArea(int nFixWid,CRect &rc,CRect &DComRc,CRect &BSRc,BOOL bShowBSUnit);
	...
	void	GetTVArea(int nFixWid,CRect &rc);
public:
	...
	DWORD	GetPadType() { return m_nNowPad; }
...
protected:
	...
	afx_msg void OnCorner3Click(UINT nID);
	...
	afx_msg void OnSwitchTopView(WPARAM wParam,LPARAM lParam);

	afx_msg void OnUpdateOtherFx(CCmdUI* pCmdUI);
	
	afx_msg	void OnLevinMenu(UINT nID);
	afx_msg	void OnSwitchWeb();
